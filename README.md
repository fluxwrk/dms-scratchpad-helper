...
- DMS 1.5.3 generates an outdated mango action for **Toggle Named Scratchpad** keybinds. This has been fixed upstream and will be resolved in a future DMS release. See [DMS PR #3118](https://github.com/AvengeMedia/DankMaterialShell/pull/3118)
